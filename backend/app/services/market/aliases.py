...
_RAW: list[tuple[str, str, str, str, str, str, str]] = [
    ...
    # ── 국내 주식 20개 ───────────────────────────────────────────────────
    # 국내 주식은 Naver adapter가 quote/OHLC 원천이다. alias도 naver_kr 6자리 코드로 고정한다.
    ("삼성전자", "naver_kr", "005930", "stock", "Samsung Electronics", "KOSPI", "KRW"),
    ("sk하이닉스", "naver_kr", "000660", "stock", "SK Hynix", "KOSPI", "KRW"),
    ("현대차", "naver_kr", "005380", "stock", "Hyundai Motor", "KOSPI", "KRW"),
    ("기아", "naver_kr", "000270", "stock", "Kia", "KOSPI", "KRW"),
    ("네이버", "naver_kr", "035420", "stock", "NAVER", "KOSPI", "KRW"),
    ("카카오", "naver_kr", "035720", "stock", "Kakao", "KOSPI", "KRW"),
    ("lg에너지솔루션", "naver_kr", "373220", "stock", "LG Energy Solution", "KOSPI", "KRW"),
    ("셀트리온", "naver_kr", "068270", "stock", "Celltrion", "KOSPI", "KRW"),
    ("포스코", "naver_kr", "005490", "stock", "POSCO Holdings", "KOSPI", "KRW"),
    ("kb금융", "naver_kr", "105560", "stock", "KB Financial", "KOSPI", "KRW"),
    ("신한지주", "naver_kr", "055550", "stock", "Shinhan Financial", "KOSPI", "KRW"),
    ("삼성sdi", "naver_kr", "006400", "stock", "Samsung SDI", "KOSPI", "KRW"),
    ("삼성바이오로직스", "naver_kr", "207940", "stock", "Samsung Biologics", "KOSPI", "KRW"),
    ("lg화학", "naver_kr", "051910", "stock", "LG Chem", "KOSPI", "KRW"),
    ("현대모비스", "naver_kr", "012330", "stock", "Hyundai Mobis", "KOSPI", "KRW"),
    ("kt", "naver_kr", "030200", "stock", "KT Corp", "KOSPI", "KRW"),
    ("sk텔레콤", "naver_kr", "017670", "stock", "SK Telecom", "KOSPI", "KRW"),
    ("한화에어로스페이스", "naver_kr", "012450", "stock", "Hanwha Aerospace", "KOSPI", "KRW"),
    ("hmm", "naver_kr", "011200", "stock", "HMM", "KOSPI", "KRW"),
    ("대한항공", "naver_kr", "003490", "stock", "Korean Air", "KOSPI", "KRW"),
]
